...
class PagesExportImport extends Wire {
	...
	function exportZIP(PageArray $items, array $options = array()) {
	}

	function importZIP($filename, array $options = array()) {
		$defaults = array(
			'id' => 0,
			'parent_id' => 0,
			'template' => '',
	...
	function exportJSON(PageArray $items, array $options = array()) {
	}
	
	function importJSON($filename, array $options = array()) {
		$defaults = array(
			'id' => 0, 
			'parent_id' => 0, 
			'template' => '',
